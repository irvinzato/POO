...
//Tengo más tareas en este ejemplo
public class ExecutorFuture2Ejemplo {
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    //Con "Executors.newSingleThreadExecutor();" se van ejecutando una en una, NO en paralelo
    //Con "Executors.newFixedThreadPool(3);" se ejecutan en paralelo. El número dice cuantas tareas estarán en paralelo
